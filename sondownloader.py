...
if __name__ == '__main__':
	...
	try:
		...
		config["sonarr_host"] = cp.get("Sickchill","host")
		config["sonarr_api_key"] = cp.get("Sickchill","api_key")
		config['sonarr_upcoming'] = cp.get("Sickchill","upcoming",fallback="missed|today|soon")
